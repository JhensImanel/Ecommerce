        ...
        <div className="dark:bg-white bg-gray-800">
          ...
          <div className="flex justify-center mb-3 mt-2 ">
            <Box className="border dark:border-blue-500 border-dark rounded-lg">
              <Link to={`/detail/${id}`}>
                <button className="py-[2px] px-[4px] items-center text-center rounded-md hover:text-black dark:hover:text-white dark:text-blue-500 text-white bg-gray-800 dark:bg-white dark:hover:bg-blue-500 hover:bg-white">
